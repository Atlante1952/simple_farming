minetest.register_node("simple_farming:carrot_crate", {
...
minetest.register_node("simple_farming:cabbage_crate", {
...
minetest.register_node("simple_farming:eggplant_crate", {
...
minetest.register_node("simple_farming:onion_crate", {
...
minetest.register_node("simple_farming:tomato_crate", {
...
minetest.register_node("simple_farming:asparagus_crate", {
...
minetest.register_node("simple_farming:potato_crate", {
...
minetest.register_node("simple_farming:strawberry_crate", {
...
minetest.register_node("simple_farming:pepper_crate", {
...
minetest.register_node("simple_farming:spinach_crate", {
...
minetest.register_node("simple_farming:rice_crate", {
...
minetest.register_node("simple_farming:corn_crate", {
...
minetest.register_node("simple_farming:beetroot_crate", {
...
minetest.register_node("simple_farming:millet_crate", {
...
minetest.register_node("simple_farming:jute_crate", {
...
minetest.register_node("simple_farming:cucumber_crate", {
...
minetest.register_node("simple_farming:sisal_crate", {
...
minetest.register_node("simple_farming:kale_crate", {
...
minetest.register_node("simple_farming:cassava_crate", {
...
minetest.register_node("simple_farming:mint_crate", {
...
minetest.register_node("simple_farming:agave_crate", {
	description = "Agave Crate",
	tiles = {"agave_crate_top.png", "crate_bottom.png", "agave_crate_side.png",
		"agave_crate_side.png", "agave_crate_side.png", "agave_crate_side.png"},
	paramtype2 = "facedir",
	is_ground_content = false,
	groups = {choppy = 3, oddly_breakable_by_hand = 2, flammable = 3},
	sounds = default.node_sound_wood_defaults(),
